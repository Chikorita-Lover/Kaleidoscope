...
public class EndCityStructureProcessor extends StructureProcessor {
    private static final MapCodec<EndCityStructureProcessor> CODEC = Codec.FLOAT.fieldOf("crackedness").xmap(EndCityStructureProcessor::new, processor -> processor.crackedness);
    private static final StructureProcessorType<EndCityStructureProcessor> TYPE = Registry.register(Registries.STRUCTURE_PROCESSOR, Kaleidoscope.of("end_city"), () -> EndCityStructureProcessor.CODEC);
    ...
    public StructureTemplate.StructureBlockInfo process(WorldView world, BlockPos pos, BlockPos pivot, StructureTemplate.StructureBlockInfo originalBlockInfo, StructureTemplate.StructureBlockInfo currentBlockInfo, StructurePlacementData data) {
        if (KaleidoscopeConfig.ADDITIONAL_CRACKED_BLOCKS.get()) {
