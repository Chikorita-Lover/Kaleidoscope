...
public class KaleidoscopeEntityTypes {
    public static final EntityType<BoatEntity> CRIMSON_BOAT = register("crimson_boat", EntityType.Builder.create(getBoatFactory(() -> KaleidoscopeItems.CRIMSON_BOAT), SpawnGroup.MISC).dropsNothing().dimensions(1.375F, 0.5625F).eyeHeight(0.5625F).maxTrackingRange(10));
    public static final EntityType<ChestBoatEntity> CRIMSON_CHEST_BOAT = register("crimson_chest_boat", EntityType.Builder.create(getChestBoatFactory(() -> KaleidoscopeItems.CRIMSON_CHEST_BOAT), SpawnGroup.MISC).dropsNothing().dimensions(1.375F, 0.5625F).eyeHeight(0.5625F).maxTrackingRange(10));
    ...
    public static final EntityType<BoatEntity> WARPED_BOAT = register("warped_boat", EntityType.Builder.create(getBoatFactory(() -> KaleidoscopeItems.WARPED_BOAT), SpawnGroup.MISC).dropsNothing().dimensions(1.375F, 0.5625F).eyeHeight(0.5625F).maxTrackingRange(10));
    public static final EntityType<ChestBoatEntity> WARPED_CHEST_BOAT = register("warped_chest_boat", EntityType.Builder.create(getChestBoatFactory(() -> KaleidoscopeItems.WARPED_CHEST_BOAT), SpawnGroup.MISC).dropsNothing().dimensions(1.375F, 0.5625F).eyeHeight(0.5625F).maxTrackingRange(10));
