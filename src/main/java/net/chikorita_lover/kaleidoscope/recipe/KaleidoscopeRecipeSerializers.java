...
public class KaleidoscopeRecipeSerializers {
    public static final CrackingRecipe.Serializer CRACKING = Registry.register(Registries.RECIPE_SERIALIZER, Kaleidoscope.of("cracking"), new CrackingRecipe.Serializer());
