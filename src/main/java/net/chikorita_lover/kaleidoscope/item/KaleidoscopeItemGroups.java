...
public class KaleidoscopeItemGroups {
    public static void register() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.COLORED_BLOCKS).register(entries -> {
            ...
            if (KaleidoscopeConfig.DYED_CHESTS.get()) {
                entries.addBefore(Items.SHULKER_BOX, Blocks.CHEST, KaleidoscopeBlocks.WHITE_CHEST, KaleidoscopeBlocks.LIGHT_GRAY_CHEST, KaleidoscopeBlocks.GRAY_CHEST, KaleidoscopeBlocks.BLACK_CHEST, KaleidoscopeBlocks.BROWN_CHEST, KaleidoscopeBlocks.RED_CHEST, KaleidoscopeBlocks.ORANGE_CHEST, KaleidoscopeBlocks.YELLOW_CHEST, KaleidoscopeBlocks.LIME_CHEST, KaleidoscopeBlocks.GREEN_CHEST, KaleidoscopeBlocks.CYAN_CHEST, KaleidoscopeBlocks.LIGHT_BLUE_CHEST, KaleidoscopeBlocks.BLUE_CHEST, KaleidoscopeBlocks.PURPLE_CHEST, KaleidoscopeBlocks.MAGENTA_CHEST, KaleidoscopeBlocks.PINK_CHEST);
            }
        });
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.FUNCTIONAL).register(entries -> {
            ...
            entries.addAfter(Blocks.CHEST, KaleidoscopeBlocks.WHITE_CHEST, KaleidoscopeBlocks.LIGHT_GRAY_CHEST, KaleidoscopeBlocks.GRAY_CHEST, KaleidoscopeBlocks.BLACK_CHEST, KaleidoscopeBlocks.BROWN_CHEST, KaleidoscopeBlocks.RED_CHEST, KaleidoscopeBlocks.ORANGE_CHEST, KaleidoscopeBlocks.YELLOW_CHEST, KaleidoscopeBlocks.LIME_CHEST, KaleidoscopeBlocks.GREEN_CHEST, KaleidoscopeBlocks.CYAN_CHEST, KaleidoscopeBlocks.LIGHT_BLUE_CHEST, KaleidoscopeBlocks.BLUE_CHEST, KaleidoscopeBlocks.PURPLE_CHEST, KaleidoscopeBlocks.MAGENTA_CHEST, KaleidoscopeBlocks.PINK_CHEST);
        });
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.COMBAT).register(entries -> {
            entries.addBefore(Items.IRON_HORSE_ARMOR, KaleidoscopeItems.CHAINMAIL_HORSE_ARMOR);
