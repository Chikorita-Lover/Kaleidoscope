...
import net.chikorita_lover.kaleidoscope.registry.RarityRegistry;
...
public abstract class ItemStackMixin {
    ...
    @ModifyExpressionValue(method = "getRarity", at = @At(value = "INVOKE", target = "Lnet/minecraft/item/ItemStack;getOrDefault(Lnet/minecraft/component/DataComponentType;Ljava/lang/Object;)Ljava/lang/Object;"))
