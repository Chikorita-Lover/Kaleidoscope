...
public abstract class ItemModelManagerMixin {
    ...
    private ItemModel getTrimmedModel(ItemModel model, ItemRenderState state, ItemStack stack, ItemModelManager itemModelManager, ItemDisplayContext displayContext, ClientWorld world, HeldItemContext heldItemContext, int i) {
        // TODO
