...
public class KaleidoscopeDataGenerator implements DataGeneratorEntrypoint {
    ...
    private static class KaleidoscopeLootTableGenerator extends FabricBlockLootTableProvider {
        ...
        public void generate() {
            ...
            this.addDrop(KaleidoscopeBlocks.BLACK_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.BLUE_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.BLUE_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.BLUE_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.BLUE_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.BLUE_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.BROWN_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.BROWN_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.BROWN_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.BROWN_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.BROWN_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.CYAN_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.CYAN_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.CYAN_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.CYAN_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.CYAN_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.GRAY_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.GRAY_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.GRAY_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.GRAY_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.GRAY_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.GREEN_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.GREEN_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.GREEN_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.GREEN_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.GREEN_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.LIGHT_BLUE_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.LIGHT_BLUE_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.LIGHT_BLUE_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.LIGHT_BLUE_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.LIGHT_BLUE_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.LIGHT_GRAY_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.LIGHT_GRAY_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.LIGHT_GRAY_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.LIGHT_GRAY_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.LIGHT_GRAY_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.LIME_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.LIME_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.LIME_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.LIME_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.LIME_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.MAGENTA_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.MAGENTA_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.MAGENTA_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.MAGENTA_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.MAGENTA_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.ORANGE_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.ORANGE_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.ORANGE_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.ORANGE_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.ORANGE_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.PINK_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.PINK_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.PINK_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.PINK_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.PINK_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.PURPLE_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.PURPLE_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.PURPLE_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.PURPLE_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.PURPLE_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.RED_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.RED_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.RED_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.RED_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.RED_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.WHITE_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.WHITE_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.WHITE_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.WHITE_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.WHITE_PAINTED_BRICK_WALL);
            this.addDrop(KaleidoscopeBlocks.YELLOW_PAINTED_BRICKS);
            this.addDrop(KaleidoscopeBlocks.YELLOW_PAINTED_BRICK_SLAB, slabDrops(KaleidoscopeBlocks.YELLOW_PAINTED_BRICK_SLAB));
            this.addDrop(KaleidoscopeBlocks.YELLOW_PAINTED_BRICK_STAIRS);
            this.addDrop(KaleidoscopeBlocks.YELLOW_PAINTED_BRICK_WALL);
    ...
    private static class KaleidoscopeRecipeGenerator extends FabricRecipeProvider {
        ...
        public static void offerBrickDyeingRecipe(RecipeExporter exporter, ItemConvertible output, ItemConvertible input) {
            ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, output, 8).input('#', Blocks.BRICKS).input('X', input).pattern("###").pattern("#X#").pattern("###").group("painted_bricks").criterion("has_bricks", RecipeProvider.conditionsFromItem(Blocks.BRICKS)).offerTo(exporter);
        }
        ...
        public static void offerGlassDoorDyeingRecipe(RecipeExporter exporter, ItemConvertible output, ItemConvertible input) {
        ...
        public static void offerGlassTrapdoorDyeingRecipe(RecipeExporter exporter, ItemConvertible output, ItemConvertible input) {
        ...
        public void generate(RecipeExporter exporter) {
            ...
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.TUFF_SLAB, Blocks.TUFF, 2);
            ...
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.BROWN_PAINTED_BRICKS, Items.BROWN_DYE);
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.CYAN_PAINTED_BRICKS, Items.CYAN_DYE);
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.GRAY_PAINTED_BRICKS, Items.GRAY_DYE);
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.GREEN_PAINTED_BRICKS, Items.GREEN_DYE);
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.LIGHT_BLUE_PAINTED_BRICKS, Items.LIGHT_BLUE_DYE);
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.LIGHT_GRAY_PAINTED_BRICKS, Items.LIGHT_GRAY_DYE);
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.LIME_PAINTED_BRICKS, Items.LIME_DYE);
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.MAGENTA_PAINTED_BRICKS, Items.MAGENTA_DYE);
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.ORANGE_PAINTED_BRICKS, Items.ORANGE_DYE);
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.PINK_PAINTED_BRICKS, Items.PINK_DYE);
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.PURPLE_PAINTED_BRICKS, Items.PURPLE_DYE);
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.RED_PAINTED_BRICKS, Items.RED_DYE);
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.WHITE_PAINTED_BRICKS, Items.WHITE_DYE);
            offerBrickDyeingRecipe(exporter, KaleidoscopeBlocks.YELLOW_PAINTED_BRICKS, Items.YELLOW_DYE);

            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.BLACK_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.BLACK_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.BLUE_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.BLUE_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.BROWN_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.BROWN_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.CYAN_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.CYAN_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.GRAY_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.GRAY_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.GREEN_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.GREEN_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.LIGHT_BLUE_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.LIGHT_BLUE_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.LIGHT_GRAY_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.LIGHT_GRAY_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.LIME_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.LIME_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.MAGENTA_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.MAGENTA_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.ORANGE_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.ORANGE_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.PINK_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.PINK_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.PURPLE_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.PURPLE_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.RED_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.RED_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.WHITE_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.WHITE_PAINTED_BRICKS, 2);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.YELLOW_PAINTED_BRICK_SLAB, KaleidoscopeBlocks.YELLOW_PAINTED_BRICKS, 2);

            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.BLACK_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.BLACK_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.BLUE_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.BLUE_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.BROWN_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.BROWN_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.CYAN_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.CYAN_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.GRAY_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.GRAY_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.GREEN_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.GREEN_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.LIGHT_BLUE_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.LIGHT_BLUE_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.LIGHT_GRAY_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.LIGHT_GRAY_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.LIME_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.LIME_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.MAGENTA_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.MAGENTA_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.ORANGE_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.ORANGE_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.PINK_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.PINK_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.PURPLE_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.PURPLE_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.RED_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.RED_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.WHITE_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.WHITE_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, KaleidoscopeBlocks.YELLOW_PAINTED_BRICK_STAIRS, KaleidoscopeBlocks.YELLOW_PAINTED_BRICKS);

            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.BLACK_PAINTED_BRICK_WALL, KaleidoscopeBlocks.BLACK_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.BLUE_PAINTED_BRICK_WALL, KaleidoscopeBlocks.BLUE_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.BROWN_PAINTED_BRICK_WALL, KaleidoscopeBlocks.BROWN_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.CYAN_PAINTED_BRICK_WALL, KaleidoscopeBlocks.CYAN_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.GRAY_PAINTED_BRICK_WALL, KaleidoscopeBlocks.GRAY_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.GREEN_PAINTED_BRICK_WALL, KaleidoscopeBlocks.GREEN_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.LIGHT_BLUE_PAINTED_BRICK_WALL, KaleidoscopeBlocks.LIGHT_BLUE_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.LIGHT_GRAY_PAINTED_BRICK_WALL, KaleidoscopeBlocks.LIGHT_GRAY_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.LIME_PAINTED_BRICK_WALL, KaleidoscopeBlocks.LIME_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.MAGENTA_PAINTED_BRICK_WALL, KaleidoscopeBlocks.MAGENTA_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.ORANGE_PAINTED_BRICK_WALL, KaleidoscopeBlocks.ORANGE_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.PINK_PAINTED_BRICK_WALL, KaleidoscopeBlocks.PINK_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.PURPLE_PAINTED_BRICK_WALL, KaleidoscopeBlocks.PURPLE_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.RED_PAINTED_BRICK_WALL, KaleidoscopeBlocks.RED_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.WHITE_PAINTED_BRICK_WALL, KaleidoscopeBlocks.WHITE_PAINTED_BRICKS);
            offerStonecuttingRecipe(exporter, RecipeCategory.MISC, KaleidoscopeBlocks.YELLOW_PAINTED_BRICK_WALL, KaleidoscopeBlocks.YELLOW_PAINTED_BRICKS);
