...
public class KaleidoscopeItemGroups {
    public static void register() {
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.BUILDING_BLOCKS).register(entries -> {
            ...
            entries.addAfter(Blocks.CUT_COPPER_SLAB, KaleidoscopeBlocks.CUT_COPPER_WALL, KaleidoscopeBlocks.SMOOTH_COPPER, KaleidoscopeBlocks.SMOOTH_COPPER_STAIRS, KaleidoscopeBlocks.SMOOTH_COPPER_SLAB, KaleidoscopeBlocks.COPPER_DOOR, KaleidoscopeBlocks.COPPER_TRAPDOOR);
            entries.addAfter(Blocks.EXPOSED_CUT_COPPER_SLAB, KaleidoscopeBlocks.EXPOSED_CUT_COPPER_WALL, KaleidoscopeBlocks.EXPOSED_SMOOTH_COPPER, KaleidoscopeBlocks.EXPOSED_SMOOTH_COPPER_STAIRS, KaleidoscopeBlocks.EXPOSED_SMOOTH_COPPER_SLAB, KaleidoscopeBlocks.EXPOSED_COPPER_DOOR, KaleidoscopeBlocks.EXPOSED_COPPER_TRAPDOOR);
            entries.addAfter(Blocks.WEATHERED_CUT_COPPER_SLAB, KaleidoscopeBlocks.WEATHERED_CUT_COPPER_WALL, KaleidoscopeBlocks.WEATHERED_SMOOTH_COPPER, KaleidoscopeBlocks.WEATHERED_SMOOTH_COPPER_STAIRS, KaleidoscopeBlocks.WEATHERED_SMOOTH_COPPER_SLAB, KaleidoscopeBlocks.WEATHERED_COPPER_DOOR, KaleidoscopeBlocks.WEATHERED_COPPER_TRAPDOOR);
            entries.addAfter(Blocks.OXIDIZED_CUT_COPPER_SLAB, KaleidoscopeBlocks.OXIDIZED_CUT_COPPER_WALL, KaleidoscopeBlocks.OXIDIZED_SMOOTH_COPPER, KaleidoscopeBlocks.OXIDIZED_SMOOTH_COPPER_STAIRS, KaleidoscopeBlocks.OXIDIZED_SMOOTH_COPPER_SLAB, KaleidoscopeBlocks.OXIDIZED_COPPER_DOOR, KaleidoscopeBlocks.OXIDIZED_COPPER_TRAPDOOR);
            entries.addAfter(Blocks.WAXED_CUT_COPPER_SLAB, KaleidoscopeBlocks.WAXED_CUT_COPPER_WALL, KaleidoscopeBlocks.WAXED_SMOOTH_COPPER, KaleidoscopeBlocks.WAXED_SMOOTH_COPPER_STAIRS, KaleidoscopeBlocks.WAXED_SMOOTH_COPPER_SLAB, KaleidoscopeBlocks.WAXED_COPPER_DOOR, KaleidoscopeBlocks.WAXED_COPPER_TRAPDOOR);
            entries.addAfter(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB, KaleidoscopeBlocks.WAXED_EXPOSED_CUT_COPPER_WALL, KaleidoscopeBlocks.WAXED_EXPOSED_SMOOTH_COPPER, KaleidoscopeBlocks.WAXED_EXPOSED_SMOOTH_COPPER_STAIRS, KaleidoscopeBlocks.WAXED_EXPOSED_SMOOTH_COPPER_SLAB, KaleidoscopeBlocks.WAXED_EXPOSED_COPPER_DOOR, KaleidoscopeBlocks.WAXED_EXPOSED_COPPER_TRAPDOOR);
            entries.addAfter(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB, KaleidoscopeBlocks.WAXED_WEATHERED_CUT_COPPER_WALL, KaleidoscopeBlocks.WAXED_WEATHERED_SMOOTH_COPPER, KaleidoscopeBlocks.WAXED_WEATHERED_SMOOTH_COPPER_STAIRS, KaleidoscopeBlocks.WAXED_WEATHERED_SMOOTH_COPPER_SLAB, KaleidoscopeBlocks.WAXED_WEATHERED_COPPER_DOOR, KaleidoscopeBlocks.WAXED_WEATHERED_COPPER_TRAPDOOR);
            entries.addAfter(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB, KaleidoscopeBlocks.WAXED_OXIDIZED_CUT_COPPER_WALL, KaleidoscopeBlocks.WAXED_OXIDIZED_SMOOTH_COPPER, KaleidoscopeBlocks.WAXED_OXIDIZED_SMOOTH_COPPER_STAIRS, KaleidoscopeBlocks.WAXED_OXIDIZED_SMOOTH_COPPER_SLAB, KaleidoscopeBlocks.WAXED_OXIDIZED_COPPER_DOOR, KaleidoscopeBlocks.WAXED_OXIDIZED_COPPER_TRAPDOOR);
        });
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.COMBAT).register(entries -> entries.addAfter(Items.DIAMOND_HORSE_ARMOR, KaleidoscopeItems.NETHERITE_HORSE_ARMOR));
