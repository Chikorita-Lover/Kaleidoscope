...
public class ModBlocks {
    ...
    public static Block registerBlockWithItem(String id, Block block, ItemGroup group) {
        Registry.register(Registry.ITEM, new Identifier(Kaleidoscope.MODID, id), new BlockItem(block, new Item.Settings().group(group)));
        return register(id, block);
    }

    public static Block register(String id, Block block) {
        return Registry.register(Registry.BLOCK, new Identifier(Kaleidoscope.MODID, id), block);
    }
