...
public class ModTradeOffers {
    public static void register() {
        ...
        TradeOfferHelper.registerVillagerOffers(ChikoritaLoverMod.GLASSBLOWER, 1, factories -> {
        ...
        TradeOfferHelper.registerVillagerOffers(ChikoritaLoverMod.GLASSBLOWER, 2, factories -> {
        ...
        TradeOfferHelper.registerVillagerOffers(ChikoritaLoverMod.GLASSBLOWER, 3, factories -> {
        ...
        TradeOfferHelper.registerVillagerOffers(ChikoritaLoverMod.GLASSBLOWER, 4, factories -> {
        ...
        TradeOfferHelper.registerVillagerOffers(ChikoritaLoverMod.GLASSBLOWER, 5, factories -> {
